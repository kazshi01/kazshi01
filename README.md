...
## 💫 SRE : データ連携システムのインフラ運用・監視・保守

`期間`: 2025 / 4 - 2025 / 9 （6ヶ月）
...
## 💫 SRE : 大手 Sler POC 環境のマルチアカウント化の導入支援
...
## ✰ CCoE : 大手 EC サイトのクラウド移行推進業務 ※ フリーに転向

`期間`: 2024 / 1 - 2024 / 10 （10ヶ月）
