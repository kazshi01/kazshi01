...
### ・Sler : 大手Slerの社内AIプラットフォーム基盤設計（受託）
...
スコープについて明示し、スケージュールを考慮したアウトプット

<br>

### ・DataOps : 大手メーカーのデータ分析基盤構築支援（受託）
...
### ・SRE : 大手SlerのPOC環境のマルチアカウント化の導入支援（受託）
