...
※ 直近 5つの案件は、同一会社にて自社システムのSREとして稼働しつつ、複数の受託案件に並行して参画しています。

### ・SRE : 自社データ連携システムのインフラ運用・監視・保守（自社）
...
### ・MLOps : 大手Slerの自社プロダクトAIプラットフォームの開発支援
...
### ・SRE : 大手SlerのPOC環境のマルチアカウント化の導入支援
